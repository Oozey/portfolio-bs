...
export default function Navbar() {
    return(
        <header className="bg-black pt-16 w-full">
            <div className="flex items-center justify-center">
                <nav className="flex">
                    ...
                    <NavLink to="/project" activeClassName="text-red" className="inflex-flex items-center py-6 px-3 mr-4 text-white text-1xl font-bold tracking-widest">
                        PROJECTS
                    </NavLink>
                    ...
                    <NavLink to="/post" activeClassName="text-red" className="inflex-flex items-center py-6 px-3 mr-4 text-white text-1xl font-bold tracking-widest">
                        PHOTOGRAPHY
                    </NavLink>
